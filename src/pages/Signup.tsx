                    ...
                    <div className="col-md-6 col-sm-6">
                      <div className="your-details">
                        ...
                        <div className="form-row">
                          ...
                          <input type="text" className="input namefild"  {...register('name')}  />
                        </div>
                        ...
                        <div className="form-row">
                          ...
                          <input type="text" className="input namefild" {...register('email')} />
                        </div>
                        ...
                        <div className="pass-wrap">
                          <div className="form-row">
                            ...
                            <input type="password" className="input namefild"  {...register('password')} />
                          </div>
                          <div className="form-row">
                            <label className="lebel-abs">
